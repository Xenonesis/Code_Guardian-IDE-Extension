...
exports.EnhancedResultsView = void 0;
...
class EnhancedResultsView {
    ...
    showResults(results) {
        if (this.panel) {
            ...
            this.panel = vscode.window.createWebviewPanel('guardianEnhancedResults', '🛡️ Guardian Security - Detailed Results', vscode.ViewColumn.Two, {
                enableScripts: true,
...
exports.EnhancedResultsView = EnhancedResultsView;
//# sourceMappingURL=enhancedResultsView.js.map