...
exports.EnhancedWebview = void 0;
const vscode = __importStar(require("vscode"));
const modernTheme_1 = require("./modernTheme");
class EnhancedWebview {
    constructor(context) {
    ...
    createWebview() {
        ...
        this.panel = vscode.window.createWebviewPanel('guardianEnhancedWebview', '🛡️ Guardian Security - Enhanced Dashboard', vscode.ViewColumn.One, {
            enableScripts: true,
...
<body>
    ...
    formatAnalysisDataForReport(data) {
        let html = '';
    ...
    getEnhancedWebviewContent(data) {
        ...
        return `
            ...
            <body>
                ...
                <script>
                    ...
                    ${modernTheme_1.modernJavaScript}
                </script>
    ...
    formatEnhancedAnalysisData(data) {
        const vulnerabilities = data.vulnerabilities?.length || 0;
        const secrets = data.secrets?.length || 0;
        const qualityScore = data.qualityMetrics?.maintainabilityScore || 0;
        const suggestions = data.suggestions?.length || 0;
            ...
            html += `
                <div style="padding: 20px; background: rgba(244, 67, 54, 0.1); border-radius: var(--border-radius); border-left: 4px solid var(--error-color);">
                    ...
                    <div style="margin-top: 15px;">
                        ${data.vulnerabilities.slice(0, 3).map((vuln) => `
        ...
        if (data.secrets && data.secrets.length > 0) {
            html += `
                <div style="padding: 20px; background: rgba(255, 152, 0, 0.1); border-radius: var(--border-radius); border-left: 4px solid var(--warning-color);">
                    ...
                    <div style="margin-top: 15px;">
                        ${data.secrets.slice(0, 3).map((secret) => `
                            <div style="font-size: 0.9em; margin: 5px 0; opacity: 0.8;">
...
exports.EnhancedWebview = EnhancedWebview;
//# sourceMappingURL=enhancedWebview.js.map