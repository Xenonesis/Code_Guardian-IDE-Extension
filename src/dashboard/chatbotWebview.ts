...
export class ChatbotWebview {
    ...
    private chatbot: GuardianChatbot;
    private currentAnalysisData: any = {};
    ...
    public createChatbotPanel(analysisData?: any): void {
        if (analysisData) {
    ...
    public updateAnalysisContext(analysisData: any): void {
        this.currentAnalysisData = analysisData;
        if (this.panel) {
    ...
    private async handleClearAllSessions(): Promise<void> {
